...
Row {
    ...
    Row {
        ...
        Text {
            text: (keyboard && keyboard.layouts && keyboard.layouts[keyboard.currentLayout]) ? keyboard.layouts[keyboard.currentLayout].shortName : "U.S"
            ...
            onTriggered: {
                try {
                    ...
                    if (lines.length > 2 && lines[2].trim()) {
                        ...
                        if (rssi >= -60)
                            wifiIcon.currentIcon = "󰤨";
                        else if (rssi >= -70)
                            wifiIcon.currentIcon = "󰤥";
                        else if (rssi >= -80)
                            wifiIcon.currentIcon = "󰤢";
                        else if (rssi >= -89)
                            wifiIcon.currentIcon = "󰤟";
                        else
    ...
    Row {
        ...
        property color batteryColor: status === "Charging" ? chargingColor : capacity <= 20 ? lowColor : normalColor
            ...
            onTriggered: {
                if (!batteryRow.batPath) {
                    ...
                    for (var i = 0; i < paths.length; i++) {
                        ...
                        x.send();
                        if (x.responseText.trim() === "Battery") {
